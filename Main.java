...
public class Main {
  ...
  System.out.println("enter your guess (only enter five vaild letters: a-z no caps, any extra letters will be disregarded and shorter answers will count)");for(i=0;i<6;i++)
  {
      // user input
